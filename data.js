...
function Logo() {
  ...
  return (
    <div>
      <p className="kareen">
        {Morning ? "Good Night Kareen, Sleep tight... 😴" : "Good Day Kreen 💞"}
      </p>
      <h1>Kareen's todo list</h1>
    </div>
  );
}
  ...
  return (
    <div>
      <div className="kareen-div">
        <h3> Kareen what do you need for today 😍</h3>
      </div>
...
function Footer({ items }) {
  ...
  return (
    <footer className="stats">
      <em>
        {percentage === 100
          ? "Weldone Kareen you reached your goal ✈"
